...
const Car = struct {
    const dist_front = 1.997;
    const dist_back = 1.283;
    const wheel_radius = 0.470976;
...
pub fn main() !void {
    ...
    while (!rl.windowShouldClose()) {
        ...
        car.speed = std.math.clamp(car.speed, -20, 20);
        ...
        camera.position = camera.target.add(Vec3.init(0, 5, 10));
        ...
        rl.drawRectangle(40, screen_height / 2 - @as(i32, @intFromFloat(15 * @max(0, car.speed))), 40, @intFromFloat(15 * @abs(car.speed)), rl.Color.white);
